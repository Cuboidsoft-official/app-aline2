...
export const APP_RELEASE_DATE = "April 22, 2026";
export const APP_RELEASE_TITLE = "Chat polish, safer media sharing, and stronger calling tools";
...
export const APP_RELEASE_HIGHLIGHTS = [
  ...
  "Chat media now uses backend nudity and explicit-content checks for safer image, GIF, and video sharing.",
  "Calls and live sessions now sound clearer, support camera switching, and include the Android Dog AR face filter flow.",
  "Release notes now reflect the fuller product feature set across feed, chat, seller, live, and account surfaces.",
];
...
export const APP_FEATURE_SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      "Protected chat media flow with backend moderation checks for nudity and explicit-content detection.",
    ],
  },
  {
...
export const APP_UPCOMING_CHANGES = [
  ...
  "Creator-side moderation expansion for posts, reels, and stories, plus optional client-side previews before upload completes.",
];
